...
import { ConfirmDialogo } from '../pilco-eliminar/confirm.dialogo/confirm.dialogo';

@Component({
  selector: 'app-pilco-listar',
  imports: [
    MatTable,
    MatSort,
    MatColumnDef,
  ...
  templateUrl: './pilco-listar.html',
  styleUrl: './pilco-listar.css',
})
export class PilcoListar {
  lista: Microscopio[];
  displayedColumns: string[] = ['id', 'codigo', 'marca', 'precio', 'fechaFabricacion', 'estado'];
